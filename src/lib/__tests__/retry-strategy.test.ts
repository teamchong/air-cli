...
describe('RetryStrategy', () => {
  ...
  describe('RetryStrategyFactory', () => {
    it('should create linear strategy', () => {
      const strategy = RetryStrategyFactory.create(
        'linear',
        RetryConfigs.browser
      )
    ...
    it('should throw on unknown strategy type', () => {
      expect(() =>
        RetryStrategyFactory.create('unknown' as any, RetryConfigs.browser)
  ...
  describe('RetryConfigs', () => {
    ...
    it('should have interaction config', () => {
      ...
      expect(RetryConfigs.interaction.retryableErrors).toContain(
        'element not found'
      )
    })
