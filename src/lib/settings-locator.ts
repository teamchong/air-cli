...
export class SettingsLocator {
   ...
   */
  findSettingsFile(
    type: 'user' | 'project' | 'local' | 'policy' = 'user'
  ): string | null {
  ...
  findAllSettingsFiles(): string[] {
    ...
    const types: Array<'user' | 'project' | 'local' | 'policy'> = [
      'user',
      'project',
      'local',
      'policy',
   ...
   */
  findClaudeMdFile(
    type: 'user' | 'project' | 'local' | 'managed' = 'user'
  ): string | null {
    let mdPath: string
  ...
  findAllClaudeMdFiles(): string[] {
    ...
    const types: Array<'user' | 'project' | 'local' | 'managed'> = [
      'user',
      'project',
      'local',
      'managed',
