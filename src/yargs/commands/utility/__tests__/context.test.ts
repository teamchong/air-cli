...
describe('context command for state visibility', () => {
  ...
  afterAll(async () => {
    ...
    console.log(
      'Context tests complete - cleanup delegated to global teardown'
    );
  });
  ...
  describe('basic context information', () => {
    ...
    it('should show page load time', async () => {
      const { output } = runCommand(
        `${CLI} context --port ${TEST_PORT} --tab-id ${testTabId}`
      );
  ...
  describe('action history tracking', () => {
    ...
    it('should show recent navigation', async () => {
      ...
      runCommand(
        `${CLI} navigate "https://example.com" --tab-id ${testTabId} --port ${TEST_PORT}`
      );
    ...
    it('should show recent clicks', async () => {
      ...
      runCommand(
        `${CLI} click --port ${TEST_PORT} "a" --tab-id ${testTabId}`,
        10000
      );
    ...
    it('should show recent form fills', async () => {
      ...
      runCommand(
        `${CLI} fill "#password=secret123" --tab-id ${testTabId} --port ${TEST_PORT}`,
        10000
      );
    ...
    it('should limit history to recent actions', async () => {
      ...
      runCommand(
        `${CLI} navigate "https://example.org" --tab-id ${testTabId} --port ${TEST_PORT}`,
        10000
      );
  ...
  describe('form state information', () => {
    ...
    it('should show filled form fields', async () => {
      ...
      // Fill some fields
      runCommand(
        `${CLI} fill "#email=user@test.com" --tab-id ${testTabId} --port ${TEST_PORT}`,
        10000
      );
